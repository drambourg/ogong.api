 ...
 */
final class Version20191004143457 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE event (id INT AUTO_INCREMENT NOT NULL, format_id INT NOT NULL, status_id INT NOT NULL, company_id INT NOT NULL, title VARCHAR(255) NOT NULL, size INT NOT NULL, registration_url VARCHAR(255) NOT NULL, logo VARCHAR(255) DEFAULT NULL, description LONGTEXT NOT NULL, end_message VARCHAR(255) NOT NULL, address VARCHAR(255) NOT NULL, date DATE NOT NULL, start_time TIME NOT NULL, end_time TIME NOT NULL, speaking_time INT NOT NULL, change_time INT NOT NULL, break_start_time TIME NOT NULL, break_end_time TIME NOT NULL, participants_per_table INT NOT NULL, number_of_tables INT NOT NULL, number_of_rounds INT NOT NULL, file_attachment VARCHAR(255) NOT NULL, is_active TINYINT(1) NOT NULL, participants_registered INT NOT NULL, participants_attended INT NOT NULL, created_at DATETIME NOT NULL, INDEX IDX_3BAE0AA7D629F605 (format_id), INDEX IDX_3BAE0AA76BF700BD (status_id), INDEX IDX_3BAE0AA7979B1AD6 (company_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, company_id INT NOT NULL, roles JSON NOT NULL COMMENT \'(DC2Type:json_array)\', first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, address VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, photo VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, INDEX IDX_8D93D649979B1AD6 (company_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE company (id INT AUTO_INCREMENT NOT NULL, owner_id INT NOT NULL, name VARCHAR(255) NOT NULL, address VARCHAR(255) NOT NULL, logo VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, UNIQUE INDEX UNIQ_4FBF094F7E3C61F9 (owner_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
